        ...
        <div class="col-md-6">
                ...
                <div class="col-md-8">
                    <dl class="dl-horizontal">
                        ...
                        <dt>Harga</dt>
                        <dd>Rp. {{$product->price}} {{--money--}}</dd>
                        <dt>Diskon</dt>
                        <dd>Rp. {{$product->discount}} {{--money--}}</dd>
                        <dt>Harga Anggota</dt>
                        <dd>Rp. {{$product->price - $product->discount}} {{--money--}}</dd>
                        {{-- added --}}
                        {{-- <dt>Harga Saya</dt> --}}
                        {{-- <dd>{{$product->price - $product->discount - $userprice}}</dd> --}}
                        {{-- added --}}
                        <dt>Stok</dt>
