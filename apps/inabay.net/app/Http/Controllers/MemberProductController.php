...
class MemberProductController extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset($user) && $user->is_active == 1) {
            if ($user->role == "Anggota") {
                ...
                // return view('home'); // tadinya gini
                // return view('home', compact('products', 'search', 'info', 'mode'));
            }
        } else {
            Auth::logout();
            return redirect('/');
    ...
    public function show($id)
    {
        ...
        // added
        $userprice = $product['discount'] - 1000;
        // 
        ...
        return view('inabay.member_area.products.show', compact('product', 'userprice', 'photo', 'user_stock_qty', 'user_seller_stock_stock'));
    }
