                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($sales_details as $sales_detail)
                            <tr>
                                ...
                                <td class="text-right">{{ $sales_detail->price }}</td>
                                <td class="text-right">{{ $sales_detail->qty * $sales_detail->price }}</td>
                            </tr>
                            @php $i++ @endphp
                        @endforeach
                        <tr>
                            <td colspan="4" class="text-right">Ongkos Kirim</td>
                            <td class="text-right"> Rp. {{ $sales->delivery_cost }} </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-right">Rp.  {{ $sales->total_sales + $sales->delivery_cost }}</td>
                        </tr>
                    </table>
                </div>
            </div>
