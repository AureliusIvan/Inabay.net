        ...
        <div class="box-body">
            ...
            <div class="col-md-5">
                ...
                <div class="boxed">
                    ...
                    <div class="box-body">
                        <b>Total Harga Rp. <span class="total_price"> {{ $total_price }} {{--money--}}</span></b>
                        @if(!$is_po)
                                ...
                                <div>
                                    <div class="alert bg-gray">
                                        <table class="table no-border no-margin">
                                            <tr>
                                                <td>Total Harga</td>
                                                <td class="text-right total_price">{{ $total_price }} {{--money--}}</td>
                                            ...
                                            <tr style="border-top:1px solid">
                                                ...
                                                <td class="text-right grand_total text-bold"> {{ $total_price }} {{--money--}}</td>
                                            </tr>
                                        </table>
                                    </div>

                                    <b>Poin Anda: Rp. {{ auth()->user()->points }} {{--money--}}</b>
                                    <br />
                                    <label>
                        ...
                        @elseif($is_po)
                            <form action="{{url('/member/sales/new-po')}}" method="post">
                                ...
                                <div>
                                    ...
                                    <label>
                                        Beli menggunkan poin?
                                        <input type="checkbox" value="1" id="use_points" name="use_points" {{ ($total_price > auth()->user()->points)? "disabled":"" }} {{--money--}}  />
                                    </label>
                                    @if($total_price > auth()->user()->points) {{--money--}}
                                        <p class="help-block">Poin Anda belum mencukupi untuk transaksi ini.</p>
                                    @endif
                                </div>
                                <button type="submit" class="btn btn-block btn-primary">Kirim</button>
