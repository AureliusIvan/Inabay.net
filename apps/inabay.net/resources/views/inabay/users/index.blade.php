                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td class="text-center">
                                <small class="label {{ $user->is_active == 1 ? 'bg-green' : 'bg-red' }}">
                                    {{ $user->is_active == 1 ? 'Aktif' : 'Tidak Aktif' }}
                                </small>
                            </td>
                            <td class="text-center"><a href="/members/edit/{{ $user->member_id }}"
                                    class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Ubah</a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        <div class="box-cust">
            @if ($users->isEmpty())
                <span class="d-flex align-items-center text-center">
                    <h3 style="color:rgb(168, 165, 165)">Anggota kosong atau tidak ada</h3>
                </span>
            @endif
            <div class="col-md-6">
            </div>
            ...
            <div class="boxmobcont">
                @foreach ($users as $user)
                    <div class="boxmob">
                        ...
                        <p><b>Telepon :</b>{{ $user->phone }}
                        <p>

                        <p><b>Poin :</b> @money($user->points)</p>
                        <p><b>Status :</b>
                            <small class="label {{ $user->is_active == 1 ? 'bg-green' : 'bg-red' }}">
                                {{ $user->is_active == 1 ? 'Aktif' : 'Tidak Aktif' }}</small>
                        </p>
                        <p><b></b><a href="/members/edit/{{ $user->member_id }}" class="btn btn-sm btn-warning"><i
